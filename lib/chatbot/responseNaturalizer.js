...
import { answeredProductFacts } from "./followUpClosings.js";
        ...
        messages: [
          {
            ...
            content:
              ...
              "Jika suggestion_generation berisi allowed_actions, buat maksimal tiga pertanyaan lanjutan baru yang paling mungkin dibutuhkan user setelah jawaban ini. Setiap item wajib memakai action_key yang diizinkan, product_indexes yang tersedia, dan kalimat question yang natural. question harus berupa kalimat yang akan diucapkan pelanggan kepada chatbot, bukan tawaran dari asisten; jangan mulai dengan 'Mau aku bantu', 'Aku bisa bantu', atau bentuk serupa. Jangan menanyakan fakta yang ditandai sudah tampil dalam answered_product_facts, termasuk harga, stok, kondisi, kelengkapan, dan detail. Prioritaskan kecocokan, alternatif, perbandingan, atau kebutuhan lain yang belum dijawab. Hindari pertanyaan dalam recent_questions. Jangan mengulang permintaan user, jangan mengarang produk atau kemampuan, dan jangan menulis URL/data sensitif. " +
