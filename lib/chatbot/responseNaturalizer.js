...
function naturalizerFieldContracts(payload = {}) {
        ...
        messages: [
          {
            ...
            content:
              ...
              "Patuhi field_contracts: setiap token numbers, urls, phrases, dan product_names harus tetap persis di field yang sama; field must_remain_empty tidak boleh diisi. " +
          ...
          },
          {
            ...
            content: JSON.stringify({
              ...
              field_contracts: naturalizerFieldContracts(payload),
              verified_facts:
...
export async function naturalizeResponseWithGroq(
  ...
  for (let index = 0; index < models.length; index += 1) {
    try {
      ...
      const shapedCandidate = preserveTextFieldShape(payload, rawCandidate);
      const firstValidationReason = naturalizedResponseSafetyIssue(
        payload,
        shapedCandidate,
      );
      ...
      if (!textChanged && firstValidationReason) {
        reportStatus(onStatus, {
          ...
          repaired_fields: repaired.repairedFields,
          suggestions_generated: generatedActions.length > 0,
        });
        return {
          ...payload,
      ...
      reportStatus(onStatus, {
        ...
        model: models[index],
        naturalized: true,
        reason: repaired.repairedFields.length
