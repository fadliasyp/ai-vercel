...
export function buildSemanticRouterMessages({
  ...
  const system = `
Kamu adalah semantic router untuk chatbot ecommerce Robot Jadul.
Tugasmu hanya memahami pertanyaan, bukan menjawab pertanyaan user.

Pilih tepat satu intent dari daftar berikut:
