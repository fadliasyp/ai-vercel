...
export function extractPromoSubjectKeywords(question = "") {
  const stopWords = new Set([
    "ada", "adakah", "apa", "apakah", "barang", "cashback", "diskon",
    "dong", "engga", "gak", "ga", "hari", "ini", "itu", "kah", "kak",
    "kalau", "kalo", "lagi", "min", "ngga", "nih", "produk", "promo",
    "saat", "sale", "saja", "sekarang", "sedang", "sih", "tidak", "yang",
  ]);
