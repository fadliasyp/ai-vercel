...
export function getImageBudgetMismatch(product = {}, constraints = {}) {
  const price = Number(
  ...
  if (constraints.budgetMax != null && price > constraints.budgetMax) {
    return { direction: "above", price, limit: constraints.budgetMax };
  }
  if (constraints.budgetMin != null && price < constraints.budgetMin) {
    return { direction: "below", price, limit: constraints.budgetMin };
  }
